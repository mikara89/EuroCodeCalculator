...
namespace InterDiagRCSection
{
    public class SolverV2
        {
            public List<CrossSectionStrainsV2> List { get; set; }
            ...
            {
                List = new List<CrossSectionStrainsV2>();
                await Task.Run(() =>
                {
                    var j = 0;
                    do
                    {
                        ...
                        {
                            var a = new CrossSectionStrainsV2(Material, Geometry, Invert);
                            a.SetByEcEs1(i, Material.armatura.eps_ud);
                            List.Add(a);
                        }
                        //if (Invert)
                        //{
                        var a1 = new CrossSectionStrainsV2(Material, Geometry, Invert);
                        ...
                        {
                            var b = new CrossSectionStrainsV2(Material, Geometry, Invert);
                        ...
                        {
                            var c = new CrossSectionStrainsV2(Material, Geometry, Invert);
                            c.SetByEcEs1(i);
                            List.Add(c);
                        }
                        //if (Invert)
                        //{
                        var c1 = new CrossSectionStrainsV2(Material, Geometry, Invert);
            ...
            public void GetWorrnings(double M, double N)
            {
                ...
                var ShotList_65 = new List<CrossSectionStrainsV2>();
                var ShotList_55 = new List<CrossSectionStrainsV2>();
                var ShotList_40 = new List<CrossSectionStrainsV2>();
                var ShotList_35 = new List<CrossSectionStrainsV2>();
                List.ForEach(x =>
                {
